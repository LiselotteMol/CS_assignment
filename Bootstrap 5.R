...
index = 1
f1_star_results_5 = rep(NA, length(r))
pq_results_5 = rep(NA, length(r))
pc_results_5 = rep(NA, length(r))


for(i in seq_along(r)) {
  candidate_test = candidates(i, signature_test)
  results_5 = f1_star(candidate_test, real_dupl_test, bootstrap_test$modelID)
  f1_star_results_5[index]= results_5[3]
  pq_results_5[index] = results_5[1]
  pc_results_5[index] = results_5[2]
  index = index + 1
}


max_h_5 = rep(NA, length(r))
index = 1
for(i in seq_along(r)) {
  ...
  max_h_5[index] <- h_seq[best_h[1]]
  index = index + 1
}

possible_comparisons_5 = rep(NA, length(r))
foc_5 = rep(NA, length(r))
f1_test_5 = rep(NA, length(r))
...
for(i in seq_along(r)) {
  ...
  cut_test <- cutree(hc_test, h = max_h_5[index])
  ...
  possible_comparisons_5 = (nrow(bootstrap_test) *(nrow(bootstrap_test)-1)) / 2
  foc_5[index] = length(which(candidate_test==1)) / possible_comparisons_5
  
  f1_test_5[index] = f1(clusters_test, real_dupl_test)
  index = index + 1
}
